view: clinical_operations_outreach {
  ...
  dimension: outreach_medium_rank {
    type: string
    label: "Outreach rank within the same medium"
    sql: ${TABLE}.outreach_medium_rank ;;
  }
  ...
  measure: average_outreach_2_3_time_in_days {
    ...
    sql: ${outreach_time} ;;
    drill_fields: [patient_uuid, sender_name, outreach_medium, average_outreach_2_3_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_outreach_3_4_time_in_days {
    ...
    sql: ${outreach_time} ;;
    drill_fields: [patient_uuid, sender_name, outreach_medium, average_outreach_3_4_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_outreach_4_5_time_in_days {
    ...
    sql: ${outreach_time} ;;
    drill_fields: [patient_uuid, sender_name, outreach_medium, average_outreach_4_5_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_outreach_5_6_time_in_days {
    ...
    sql: ${outreach_time} ;;
    drill_fields: [patient_uuid, sender_name, outreach_medium, average_outreach_5_6_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_phone_outreach_0_1_time_in_days {
    ...
    drill_fields: [patient_uuid, sender_name, average_phone_outreach_0_1_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_phone_outreach_1_2_time_in_days {
    ...
    drill_fields: [patient_uuid, sender_name, average_phone_outreach_1_2_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_phone_outreach_0_2_time_in_days {
    ...
    sql: ${creation_outreach_time} ;;
    drill_fields: [patient_uuid, sender_name, average_phone_outreach_0_2_time_in_days]
    value_format_name: decimal_2
  }
  ...
  measure: average_phone_outreach_2_3_time_in_days {
    ...
    filters: [outreach_medium_time: ">=0", outreach_date_date: "-NULL", next_outreach_medium_date_date: "-NULL",
      outreach_medium_rank: "2", outreach_medium: "phone"]
    sql: ${outreach_medium_time} ;;
    drill_fields: [patient_uuid, sender_name, average_phone_outreach_2_3_time_in_days]
    value_format_name: decimal_2
  }
